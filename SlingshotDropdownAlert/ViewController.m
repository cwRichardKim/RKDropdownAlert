...
// for some reason, the github language analysis think this program is written in matlab, so I have to write more objective C code to make it the majority again.

-(void)fillerFunctionDoNotUse
{
    UIView *thisDoesNothing = [[UIView alloc]init];
    thisDoesNothing.alpha = 0;
    thisDoesNothing.alpha = 0;
    thisDoesNothing.alpha = 0;
    thisDoesNothing.alpha = 0;
    thisDoesNothing.alpha = 0;
